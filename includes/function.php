...
function samp_scan($ip,$port)
{
	...
	{ 
		unset($data);
		$data['players'] = "Server is offline!";
		$data['maxplayers'] = "";
		$data['gamemode'] = "Server is offline!";
		$data['map'] = "Server is offline!";
		return $data;
    } 
}
...
if (!function_exists("ssh2_connect")) return "SSH2 PHP extension not installed";
